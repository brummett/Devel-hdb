function Debugger(sel) {
    ...
    function BreakpointManager() {
        ...
        function combinedBreakpointAction(filename, line) {
            var bp = breakpoints[filename] ? breakpoints[filename] : {},
                action = actions[filename] ? actions[filename] : {};
            var combined = {};
            ...
            if (line === undefined) {
                ...
                //[breakpoints, actions].forEach(function(item) {
                //    if ((filename in item) && (line in item[filename])) {
                //        jQuery.extend(combined[line], item[filename][line]);
                //    }
                //});
            }
            return combined;
        ...
        function makeUpdateMessageHandler(storage, code_key) {
            return function(data) {
                ...
                if (code) {
                    // breakpoint/action in a new file
        ...
        this.breakpointUpdated = makeUpdateMessageHandler(breakpoints, 'condition');
        this.actionUpdated = makeUpdateMessageHandler(actions, 'action');
        ...
        messageHandler.addHandler('breakpoint', this.breakpointUpdated.bind(this))
        messageHandler.addHandler('action', this.actionUpdated.bind(this))
    };
}
