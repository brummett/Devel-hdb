function Debugger(sel) {
    ...
    this.breakpointsForPane = function(e, bp_hash) {
        ...
        for (line in bp_hash) {
            ...
            if (condition) {
                if (condition === '1') {
                    lineElt.removeClass('conditional-breakpoint inactive-breakpoint')
                        .addClass('breakpoint');
                } else {
                ...
                lineElt.removeClass('breakpoint conditional-breakpoint inactive-breakpoint');
            }
        }
    };
    ...
    this._drawBreakpointMenu = function($elt) {
        var filename = $elt.closest('div.tab-pane').attr('data-filename'),
            lineno = $elt.closest('tr').attr('data-line'),
            bp = this.breakpointManager.get(filename, lineno) || '0',
            menu = this.breakpointRightClickMenu({  bp: bp.condition,
                                                    action: bp.action,
                                                    filename: filename,
                                                    lineno: lineno});
    ...
    function BreakpointManager() {
        ...
        this.set = function(params) {
            ...
            this.breakpoints[filename][lineno] = condition;
