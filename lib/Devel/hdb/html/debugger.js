function Debugger(sel) {
    ...
    this.initialize = function() {
        ...
        this.elt.on('click', '#save-breakpoints',
                    this.saveBreakpoints.bind(this));
        this.elt.on('click', '#load-breakpoints',
                    this.loadBreakpoints.bind(this));
    ...
    this.saveBreakpoints = function(e) {
    ...
    this.loadBreakpoints = function(e) {
        var modal = $( this.saveLoadBreakpointsModalTemplate({
                                    action: 'Load',
                                    filename: this._defaultBreakpointFileName()
                        }))
        ...
        var requestDone = this.messageHandler.consumerSession(function(data) {
                modal.modal('hide');
            });
