function BreakpointManager($main_elt, rest_interface) {
    ...
    this.removeBPAction = function(type, filename, line) {
        var storage = type === 'breakpoint' ? breakpoints : actions,
    ...
    this.createBreakpoint = function(params) {
        rest_interface.createBreakpoint(params)
            .done(function(data) {
                ...
                storeCreatedBPAction('breakpoint', bp);
                updateForChangedBPAction('breakpoint', bp);
            })
    ...
    this.createAction = function(params) {
        rest_interface.createAction(params)
            .done(function(data) {
                ...
                storeCreatedBPAction('action', bp);
                updateForChangedBPAction('action', bp);
            })
            .fail(function(jqxhr, text_status, error_thrown) {
    ...
    function breakableLineClicked(e) {
        ...
        if (this.getBreakpoint(filename, line)) {
            this.removeBPAction('breakpoint',filename, line);
        } else {
    ...
    function removeFromBreakpointList(e) {
        ...
        this.removeBPAction('breakpoint',filename, line);
        this.removeBPAction('action',filename, line);
    }
